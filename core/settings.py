...
SECRET_KEY = config("SECRET_KEY",default='django-insecure-xm^v=+4leq1*)5b9cr6)433=-h$as=8&sdj4o*nbj2yd$h2b62')
...
DATABASES = {
    'default': {
        ...
        'NAME': config("PGDB_NAME",default='djangoshop'),                      
        'USER': config("PGDB_USER",default='postgres'),
        'PASSWORD': config("PGDB_PASSWORD",default='0023004622'),
